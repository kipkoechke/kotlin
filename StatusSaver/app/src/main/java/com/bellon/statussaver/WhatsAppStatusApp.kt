                    ...
                    NavigationBar(
                        ...
                        val items = listOf(
                            BottomNavigationItem(
                                ...
                                selectedIcon = Screen.Status.selectedIcon,     // Already an @DrawableRes Int
                        ...
                        items.forEachIndexed { index, item ->
                            NavigationBarItem(
                                ...
                                label = {
                                    Text(text = item.title, fontSize = 14.sp, color = if (selectedItemIndex == index) MaterialTheme.colorScheme.primary else Color.Gray)
                                },
